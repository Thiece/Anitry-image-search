...
@click.option('--batch_size', default=64, help='Batch size for DataLoader.')
...
def compute_embeddings(img_dir, save_path, batch_size, num_workers):
    ...
    model, preprocess = clip.load_from_name('ViT-H-14', device=device, download_root='./chinese_clip')
